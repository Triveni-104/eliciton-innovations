      ...
      <section className="section-pad">
        <div className="wrap">
          ...
          <div className="news-grid reveal-stagger">
            ...
            <div className="news-card">
              <div className="news-img">
                <svg style={{ width: '100%', height: '100%', background: 'linear-gradient(135deg,var(--teal-dark),var(--plum))', display: 'flex', alignItems: 'center', justifyContent: 'center' }} viewBox="0 0 400 190">
                  <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fontFamily="'Outfit', sans-serif" fontWeight="700" fontSize="28" fill="#FCBC66">ELICITON</text>
                </svg>
              </div>
              <div className="news-body">
                <div className="news-date">FEBRUARY 28, 2026</div>
                <h3>PPRV lateral flow strip sensitivity baseline established</h3>
                <p>Evaluation run curves verify sub-nanomolar detection capabilities for active capsid proteins in blood serum isolates.</p>
              </div>
            </div>
