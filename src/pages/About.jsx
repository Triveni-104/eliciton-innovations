        ...
        <div className="wrap">
          ...
          <div className="why-grid reveal-stagger">
            ...
            <div className="why-item">
              ...
              <p>Covering Brucella, Pasteurella, FMD, PPR, and other high-priority One Health zoonotic bacterial isolates.</p>
            </div>
            <div className="why-item">
          ...
          <div className="stats-strip reveal-stagger" id="statsStrip">
            <StatItem targetValue={98.5} label="ELISA Assay Accuracy" />
